...
// 版本管理
import { checkVersionAndClearCache, addVersionInfo } from '@/utils/version'

// 测试工具（开发环境）
import '@/utils/testInteractions'
import '@/utils/testThemeMusic'
import '@/utils/debugNightMusic'
import '@/utils/projectAcceptance'
import '@/utils/musicTest'
...
onMounted(() => {
  // 检查版本并清理缓存
  const versionUpdated = checkVersionAndClearCache()
